...
public class car_front extends ArrayAdapter {
    ...
    public car_front(@NonNull Context context, int resources, List<String> titles, List<String> subtitle, List<Integer> images){
